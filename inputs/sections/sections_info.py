    ...
    quizzes = [
        {"quizzes": 
            {"dish descriptions": {
                ...
                "examples": {
                    "example_1" :"""When describing a seasonal special, '[Insert Seasonal Dish Name],' which description would make it sound the most enticing?
                    ...
                    **Correct Answer: B**
                    """,
                    "example_2": """You're crafting a menu description for the **[Insert Seasonal Dish Name].** Which option best uses vivid imagery to entice diners?
                    ...
                    **Correct Answer: B**
                    """,
                    "example_3": """How would you describe the [Insert Seasonal Dish Name] to make it stand out as a light yet flavorful starter?
